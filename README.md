...
| 0.1.2   | <ul><li>Added health bars</li><li>Optimized chunk loading; client now discards chunks outside of render distance</li><li><a href="https://github.com/definitely-nobody-is-here/Mountain_Guarder/issues/46" target="_blank">Fixed player tint lag (Issue #42)</a></li><li>Retextured arrow to make it more pixel consistent</li><li>Restructured movement AI to allow players and NPC to have ability to path</li></ul> |
